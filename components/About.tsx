export default function About() {
  return (
    <section id="about" className="pt-[100px] pb-3 max-md:pt-6 max-md:pb-1 px-6 text-center bg-[var(--bg2)]">
      ...
      <img src="/signature.png" alt="عمر العُمر"
        className="block h-24 md:h-32 w-auto object-contain mx-auto mt-4 md:mt-8 mix-blend-screen" />
    </section>
  );
}
