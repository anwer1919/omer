...
export default function Social() {
  ...
  return (
   <section id="contact" className="pt-14 pb-6 max-md:pt-3 max-md:pb-1 px-3 md:px-6 text-center">
      ...
      <p dir="ltr" className="mt-3 md:mt-10 text-[12px] md:text-sm text-[var(--muted)] tracking-wider flex items-center justify-center flex-wrap gap-2 md:gap-3">
