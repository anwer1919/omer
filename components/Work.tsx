const cards = [
  ...
  { name: 'نقوة الدار', desc: 'علامة سعودية للمنتجات المنزلية، تضع الجودة والثقة في صميم التجربة.', img: '/logos/naqwa-new.png', href: 'https://edmarksa.com/', pos: 'object-[center_0%] scale-[0.85]', mask: '[mask-image:linear-gradient(to_bottom,#000_78%,transparent_98%)]' },
];
