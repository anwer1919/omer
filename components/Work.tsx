const cards = [
  ...
  { name: 'نقوة الدار', desc: 'علامة سعودية للمنتجات المنزلية، تضع الجودة والثقة في صميم التجربة.', img: '/logos/naqwa-new.png', href: 'https://edmarksa.com/', pos: 'object-[center_20%] max-md:object-[center_25%]', mask: '[mask-image:linear-gradient(to_bottom,#000_65%,transparent_85%)]' },
];
