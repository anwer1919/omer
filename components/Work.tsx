const cards = [
  ...
  { name: 'نقوة الدار', desc: 'علامة سعودية للمنتجات المنزلية، تضع الجودة والثقة في صميم التجربة.', img: '/logos/naqwa-new.png', href: 'https://edmarksa.com/', pos: 'object-[center_78%] max-md:object-[center_82%]' },
];

export default function Work() {
  return (
    <section id="work" className="py-0.5 md:py-2 px-3 md:px-6 bg-[var(--bg)]">
