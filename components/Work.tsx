...
export default function Work() {
  return (
    <section id="work" className="pt-4 md:pt-8 pb-[110px] max-md:pb-10 px-3 md:px-6">
      <p className="text-center text-sm text-[var(--gold)] mb-6 md:mb-10">الخبرة والأعمال</p>
