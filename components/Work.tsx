          ...
          const inner = (
            <>
              ...
              <img src={c.img} alt={c.name}
                className="absolute inset-0 size-full object-contain p-3 md:p-6 mix-blend-screen group-hover:brightness-110 transition" />
              {/* النص شفاف فوق الصورة — بدون أي خلفية */}
