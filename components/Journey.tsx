...
export default function Journey() {
  return (
    <section id="journey" className="py-[120px] max-md:py-[72px] px-6 max-w-[800px] mx-auto">
      ...
      <a href="/profile.pdf" download className="mt-12 mx-auto block w-fit h-[52px] px-8 rounded-full border border-[var(--gold)] text-[var(--gold)] grid place-items-center hover:bg-[var(--glow)]">تحميل الملف التعريفي PDF</a>
    </section>
  );
}
