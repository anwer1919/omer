  ...
  return (
    <section id="home" className="relative overflow-hidden bg-[var(--bg)]">
      <div className="relative w-full min-h-[70vh] md:min-h-[85vh]">
        ...
        <div className="relative z-10 flex flex-col justify-between h-full min-h-[70vh] md:min-h-[85vh] px-3 md:px-14 pt-[48px] md:pt-[56px] pb-[32px] md:pb-[40px]">
          {/* الاسم + الكلمة الإنجليزية — أعلى */}
          <div className="w-full md:w-[45%] md:ml-auto">
            <div className="inline-block self-start">
              ...
              <span className="block h-[2px] w-full bg-[#d9a066] rounded-full mt-1" />
            </div>
          ...
          {/* الأزرار — أسفل، محاذية لأسفل الصورة */}
