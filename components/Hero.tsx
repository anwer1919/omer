...
export default function Hero() {
  return (
    <section id="home" className="relative overflow-hidden bg-[var(--bg)]">
      <div className="relative w-full px-3 md:px-14 pt-[48px] md:pt-[56px] pb-[32px] md:pb-[40px]">
        {/* الصورة */}
        ...
        <div className="relative z-10 flex flex-col md:w-[45%] md:ml-auto">
          ...
          <p dir="ltr" className="gold-shine font-sans tracking-[.2em] md:tracking-[.35em] text-[9px] md:text-sm mt-1 md:mt-2 text-right">FOUNDER • BRAND BUILDER</p>
