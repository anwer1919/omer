    ...
    <section id="home" className="relative overflow-hidden bg-[var(--bg)]">
      <div className="relative w-full px-3 md:px-14 pt-[72px] md:pt-[80px]">
        ...
        <div className="relative z-10 flex flex-col md:w-[45%] md:ml-auto">
          ...
          <span className="block h-px w-10 md:w-14 bg-[var(--champagne)] mt-1 md:mt-2" />
          <p dir="ltr" className="font-sans text-[var(--gold)] tracking-[.2em] md:tracking-[.35em] text-[9px] md:text-sm mt-1 md:mt-2 text-right">FOUNDER • ENTREPRENEUR</p>
