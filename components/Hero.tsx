export default function Hero() {
  return (
    <section id="home" className="min-h-screen grid md:grid-cols-2">
      <div className="order-2 md:order-none md:col-start-1 flex flex-col justify-center px-6 md:px-16 pt-[110px] md:pt-[72px] pb-16">
        <h1 className="text-5xl md:text-[68px] font-semibold leading-[1.2]">عمر العمر</h1>
      ...
      <div className="order-1 md:order-none md:col-start-2 relative h-[65vh] md:h-auto">
        <img src="/portrait.png" alt="عمر العمر" className="absolute inset-0 size-full object-cover object-top" />
